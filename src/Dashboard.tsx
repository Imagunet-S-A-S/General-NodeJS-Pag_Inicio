...
const apps: AppLink[] = [
  ...
  { name: "Zabbix", url: "https://zabbixkallpa.electrodata.com.pe/zabbix/", imageSrc: "/zabbix.png" },
  ...
  { name: "Grafana", url: "https://zabbixkallpa.electrodata.com.pe/grafana/", imageSrc: "/grafana.png" },
...
const Dashboard: React.FC = () => {
    ...
    return (
      <Box
        sx={{
          background: "linear-gradient(135deg, #6a4a8fff 0%, #ffffff 100%)",
          minHeight: "100vh",
          display: "flex",
